...
echo "   # or: make up"
echo ""
echo "🏭 Start production-exact stack (slower on ARM Macs):"
echo "   docker-compose --profile production up -d"
echo "   # or: make up-production"
echo ""
...
echo ""
echo "🏭 Production services (if started):"
echo "   Webview (Production): http://localhost:8081"
echo "   Backend API (Production): http://localhost:3159"
echo ""
